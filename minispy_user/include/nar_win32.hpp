...
int8_t BG_API NarGetVolumeDiskType(char Letter);
...
static inline bool NarIsOSVolume(char Letter) {
    char windir[256];
...
BG_API bool NarFeedRestoreTarget(restore_target *Target, const void *Buffer, uint32_t BufferSize);
