...
set compile_flags= -nologo /I"../inc" /GS- /MTd /EHsc /W3 /wd4018 /Od /Zi /DEBUG:FULL /FC /F 16777216 /std:c++17 /MP /fsanitize=address
...
cl main.cpp file_explorer.cpp platform_io.cpp restore.cpp nar_win32.cpp nar.cpp package.cpp %build_options% %compile_flags% /I"../inc" %linker_flags%
